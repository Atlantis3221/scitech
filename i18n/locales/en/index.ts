export default {
    test: {
        ...
        "Подготовка к защитам проектов, питч-сессии": "Linear management in scientific and R&D projects, centres, laboratories",
        "Подготовка и финальная защита проектов в рамках Международного молодежного научно-практического форума «Нефтяная столица» (г.Сургут)": "Preparation and presentation of projects",

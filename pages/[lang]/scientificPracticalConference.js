...
const day18 =  (<div className="day" id="18">
  <div className="event">
    <h4>
      18 Октября, понедельник 14:00 – 15:30 МСК.
    </h4>
    <p>1. Интеграция России в мировую климатическую повестку. Развитие и формирование карбоновых полигонов. Зеленые ценности и устойчивое развитие.</p>
    ...
    <p className="mb-0">— Гатиятов Айрат Ринатович, заместитель министра науки и высшего образования РФ</p>
    <p className="m-0">— Дурманов Николай Дмитриевич, заместитель директора по развитию Института X-BIO Тюменского государственного университета,
      специальный представитель Минобрнауки РФ по вопросам биологической и экологической безопасности</p>
    <p className="m-0">— Кошель Алексей Сергеевич, проректор по общим вопросам ФГАОУ ВО «Дальневосточный федеральный университет»</p>
    <p className="m-0">— Люлин Сергей Владимирович, член-корреспондент РАН, профессор РАН, доктор физико-математических наук</p>
...
const day19 =  (<div className="day" id="19">
  <div className="event">
    <h4>
      19 Октября, вторник 14:00 – 15:30 МСК.
    </h4>
    <p>2. Научно-образовательные консорциумы: Научно-образовательные центры мирового уровня и Приоритет 2030</p>
    <p>Модератор: Евгений Сженов, научный руководитель ЭАЦ «Научно-образовательная политика», ведущий эксперт Института образования НИУ ВШЭ</p>
    <p>Приглашены к участию:</p>
    ...
    <p className="m-0">— Михеева Ольга Александровна, генеральный директор АНО «Институт регионального развития»</p>
    ...
    <p className="m-0">— Романчук Иван Сергеевич, ректор ФГАОУ ВО «Тюменский государственный университет»</p>
    <p className="m-0">— Рудской Андрей Иванович, ректор ФГАОУ ВО «Санкт-Петербургский политехнический университет Петра Великого»</p>
    <p className="m-0">— Федюшкин Игорь Леонидович, генеральный директор АНО «Нижегородский НОЦ»</p>
...
const day20 =  (<div className="day" id="20">
  <div className="event">
    <h4>
      20 Октября, среда 14:00 – 15:30 МСК.
    </h4>
    <p>3. Человеческий капитал как важная составляющая трансформации и инновационного развития науки и
      технологий в повестке научно-образовательных центров мирового уровня</p>
    <p>Модератор: Евгений Сженов, научный руководитель ЭАЦ «Научно-образовательная политика», ведущий эксперт Института образования НИУ ВШЭ</p>
    <p>Приглашены к участию:</p>
    <p className="mb-0">— Авитисян Арутюн Ишханович, директор ФГБУН «Институт системного программирования им. В.П. Иванникова РАН»</p>
    ...
    <p className="m-0">— Комиссаров Алексей Геннадиевич, генеральный директор АНО «Россия – страна возможностей»</p>
    ...
    <p className="m-0">— Сергеев Александр Михайлович, президент ФГБУ «Российская академия наук», академик РАН, доктор физико-математических наук, профессор</p>
...
const day22 =  (<div className="day" id="22">
  <div className="event">
    <h4>
      22 Октября, пятница 14:00 – 15:30 МСК.
    </h4>
    <p>4. Арктика и человек в Арктике. Вызовы и контуры будущего развития циркумполярного мира</p>
    <p>Модератор: Евгений Сженов, научный руководитель ЭАЦ «Научно-образовательная политика», ведущий эксперт Института образования НИУ ВШЭ</p>
    <p>Приглашены к участию:</p>
    <p className="mb-0">— Алашкевич Михаил Юрьевич, старший Вице-президент, руководитель проектного офиса Агентской функции ГКР «ВЭБ.РФ»</p>
    <p className="m-0">— Кудряшова Елена Владимировна, ректор ФГАОУ ВО «Северный (Арктический) федеральный университет имени М.В. Ломоносова»</p>
    ...
    <p className="m-0">— Пастухова Лариса Сергеевна, научный руководитель, автор концепции конкурса «Моя страна – моя Россия»</p>
    <p className="m-0">— Сергеев Александр Михайлович, президент ФГБУ «Российская академия наук», академик РАН, доктор физико-математических наук, профессор</p>
    <p className="mt-0">— Фрумин Исак Давидович, научный руководитель Института образования НИУ «Высшая школа экономики»</p>
  </div>
</div>)

  ...
  <div className="event">
    ...
    <EventItem_Container>
      ...
      <EventItem date_add='14:00 — 15:30 МСК'
        ...
        <p className="mb-0">— Люлин Сергей Владимирович, заместитель президента РАН, член-корреспондент РАН, профессор РАН, доктор физико-математических наук</p>
  ...
  <div className="event">
    ...
    <EventItem_Container>
      ...
      <EventItem date_add='14:00 — 15:30 МСК'
        ...
        <p className="mt-0">— Пилясов Александр Николаевич, доктор географических наук, профессор ФГБОУ ВО «МГУ имени М.В. Ломоносова»,

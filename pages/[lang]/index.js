                    ...
                    <ul className='g3'>
                      <li className='i3_4'>
                          <div className='link_toEvent'>
                            <a href={`/${lang}/projectManagementSchool`} className='link_event'>
                              {current["Школа управления проектами в медицине и биотехнологиях"]}
                              <svg
                                width='12'
                                height='12'
                                viewBox='0 0 12 12'
                            ...
                            <div className='link_data'>{current["Июнь"]} 2022 - {current["Декабрь"]} 2022</div>
                          </div>
                        </li>
                    </ul>
                  </li>

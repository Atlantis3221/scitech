                      ...
                      <ul className='g3'>
                        <li className='i3_12 flex_between'>
                          <div>
                            ...
                            <p className='raleway'>
                              {current['Февраль']} 2021 - {current['Февраль']} 2022
                            </p>
                          </div>
            ...
            <div className='content'>
              <ul className='g3'>
                ...
                <li className='i3_9'>
                  <SpeakerCards>
                    <SpeakerCard
                      photo='/img/speaker_irina.png'
                      fullName={current['Ирина Шрайбер']}
                      position={current['ментор']}
                    >
                      {current['Ph. D., кандидат физико-математических наук, ученый, исследователь, лектор']}
                    </SpeakerCard>
                    <SpeakerCard
                      photo='/img/roman_osvald.png'
                      fullName={current['Роман Оствальд']}
                      position={current['руководитель проектной работы']}
                    >
                      {
                        current[
                  ...
                  <li className='i3_9'>
                    <SpeakerCards>
                      ...
                      <SpeakerCard photo='/img/speaker_teslinov.png' fullName='Андрей Теслинов'>
                        Доктор технических наук, генеральный директор НКГ «DBA—concept», Executive Professor ИБДА
                        РАНХиГС
                      </SpeakerCard>
                      ...
                      <SpeakerCard photo='/img/speaker_kizeev.png' fullName='Вениамин Кизеев'>
                        IPMA Level«B», член правления НП «СОВНЕТ», эксперт по управлению проектами и инновациями
                        компании WINbd
                      </SpeakerCard>
                      <SpeakerCard photo='/img/speaker_walker.png' fullName='Уолкер Спенсер'>
                        Head of Deseret First Financial Services, менеджер Центра коммерциализации и трансфера
                        технологий Университета Юты, Член правления DFFCU. 2015-2018 управляющий партнер в Main Street
                        Capital Partners
                      </SpeakerCard>
                      ...
                      <SpeakerCard
                        order4
                        photo='/img/speaker_latyshev.png'
                      ...
                      <SpeakerCard
                        ...
                        position='руководитель проектной работы'
                      >
                        Канд. хим. наук. Проректор СурГУ по науке и технологиям. Руководитель проектной работы SLS
                      </SpeakerCard>
                    </SpeakerCards>
            ...
            <div className='content'>
              <ul className='g3'>
                <li className='i3_3'>
                  ...
                  <p className='asideMarker asideMarker_mt1'>
                    20 {current['марта']} - 2 {current['апреля']} 2021
                  </p>
                </li>
                <li className='i3_9'>
                  <ul className='g3'>
                    <li className='i3_12'>
                      <ul className='g3'>
                        <li className='i3_12'>
                          <h4 className='mt1'>
                            {current['Лидерство и эффективная командная работа в научной среде. Форсайт в науке']}
                          </h4>
                        </li>
                      </ul>
                    </li>
                  ...
                  <ul className='g3'>
                    <li className='i3_12'>
                      <ul className='g3'>
                        <li className='i3_12'>
                          <h4 className='mt1'>
                            {current['Научный протокол и управление знаниями. Академическое письмо.']}
                          </h4>
                        </li>
                      </ul>
                    </li>
                  ...
                  <ul className='g3'>
                    <li className='i3_12'>
                      <ul className='g3'>
                        <li className='i3_12'>
                          <h4 className='mt1'>
                            {current['Проектное управление в науке. Разработка и создание устава проекта.']}
                          </h4>
                        </li>
                      </ul>
                    </li>
                  ...
                  <ul className='g3'>
                    <li className='i3_12'>
                      <ul className='g3'>
                        <li className='i3_12'>
                          <h4 className='mt1'>
                            {current['Фандрайзинг, финансирование и работа с грантовыми фондами. Научная экспертиза']}
                          </h4>
                        </li>
                      </ul>
                    </li>
                  ...
                  <ul className='g3'>
                    <li className='i3_12'>
                      <ul className='g3'>
                        <li className='i3_12'>
                          <h4 className='mt1'>
                            {current['Коммуникации ученого в современном мире: власть, бизнес, социум']}
                          </h4>
                        </li>
                      </ul>
                    </li>
                      ...
                      <ul className='g3'>
                        <li className='i3_12'>
                          <h4 className='mt1'>
                            {
                              current[
                                'Стратегия управления научно-исследовательской деятельностью. Трансфер технологий'
                              ]
                            }
                          </h4>
                        </li>
                      ...
                      <ul className='g3'>
                        <li className='i3_12'>
                          <h4 className='mt1'>
                            {
                              current[
                                'Эффективная работа со стейкхолдерами научных и научно-исследовательских проектов'
                              ]
                            }
                          </h4>
                        </li>
                      ...
                      <ul className='g3'>
                        <li className='i3_12'>
                          <h4 className='mt1'>
                            {
                              current[
                                'Эффективное представление и защита научного (научно-исследовательского) проекта: теория и практика'
                              ]
                            }
                          </h4>
                        </li>
                    ...
                    <ul className='g3'>
                      <li className='i3_12'>
                        <ul className='g3'>
                          <li className='i3_12'>
                            <p>
                              Для команд и индивидуальных участников от организаций Западно-Сибирского НОЦ обучение
                              ...
                              Западно-Сибирского НОЦ участие платное.
                            </p>
                            <br />
                            <a className='raleway_bold' href='/docs/projects&experts.pdf' download>
                              Проекты и эксперты второго потока 2021-2022
                            </a>
                          </li>
                        </ul>
                      </li>
            ...
            <div className='content'>
              <ul className='g3'>
                ...
                <li className='i3_9 border_top'>
                  ...
                  <p className='titleBlock'>{current['schoolStreamres']}</p>
                  ...
                  <ul className='g3'>
                    <li className='i3_12' style={{ marginTop: '2.5rem' }}>
                      <a
                        href={`/${lang}/school2019_2020/#projects`}
            ...
            <div className='container'>
              <ul className='g3'>
                ...
                <li className='i3_9' style={{ marginBottom: '2.5rem' }}>
                  <p className='feedback_name feedback_name_pt_low'>
                    Захаров Антон Викторович – кандидат педагогических наук, начальник научного отдела Ишимского
                    педагогического института им. П.П. Ершова, участник проекта «Разработка модели зеленой трансформации
                    региона: ценности, практики, социально-экономические эффекты».
                  </p>
                  ...
                  <div className='feedBack_descript_container'>
                    <p className='feedBack_descript'>
                      Полагаю, что никто из участников не подозревал, что через год учебы и работы над своими проектами
                      в Школе мы сможем получать такие высокие результаты. Идея данной Школы - это опережающая
                      подготовка лидеров в научных исследованиях нового формата, готовых работать в логике
                      инновационного процесса. Это значит последовательного воплощения научных идей в инновации,
                      разработку технологии их производства, вывод исследовательского продукта на рынок. Подобная логика
                      «исследование - инновации - производство - рынок» легла в основу модулей Школы научного лидерства
                      и позволила вновь созданным командам практически с нуля получить серьезные результаты.
                    </p>
                    <p className='feedBack_descript'>
                      Наш проект «Разработка модели зеленой трансформации региона: ценности, практики,
                      социально-экономические эффекты» дошел до итоговой защиты как один из перспективных и отличающийся
                      необходимыми результатами. За время обучения в школе нам удалось подготовить более 10 научных
                      статей, обеспечить привлечение НИОКР и выиграть грант РФФИ. Самое главное, у нас получилось
                      собрать уникальную, дружную, междисциплинарную команду проекта готовую работать в рамках
                      Западно-Сибирского Межрегионального научно-образовательного центра.
                      <br />
                      ...
                      уровень организации Школы, желание помочь, и профессионализм.
                    </p>
                  </div>

                  <p className='feedback_name'>
                    Участник проекта «Многоуровневая система оценки риска развития заболевай работников в Арктике»
                  </p>
                  <p className='feedBack_title'>
                    Занятия с компетентными специалистами помогли полноценно доработать проект, определить основные
                    этапы и шаги в его реализации.
                  </p>
                  <div className='feedBack_descript_container'>
                    <p className='feedBack_descript'>
                      Школа научных лидеров предоставила возможности для продвижения научного проекта нашей команды.
                      Занятия с компетентными специалистами помогли полноценно доработать проект, определить основные
                      этапы и шаги в его реализации. Начиная с первого модуля, мы корректировали и видоизменяли
                      структуру проекта таким образом, чтобы он был понятен не только узким медицинским специалистам.
                      Рекомендации спикеров и экспертов позволили оформить презентационный материал, раскрывающий суть
                      нашего проекта и четко в сжатой форме обосновать необходимость его реализации. Представление
                      проекта с последующим обсуждением помогло становлению необходимых компетенций публичных
                      выступлений и взаимодействия с широким кругом аудитории.
                    </p>
                    <p className='feedBack_descript'>
                      Важным для нас как исследователей была трансформация понимания научного проекта, который должен
                      быть реализован в конкретном продукте. Это позволило по-другому посмотреть на нашу научную работу
                      с формированием понимания потребностей конечных потребителей, ключевых заинтересованных лиц и
                      главное лиц принимающих решения. Если вы хотите, чтобы ваши научные исследования нашли
                      практическую реализацию, то школа научного лидерства это именно та площадка, где это возможно
                      реализовать!
                    </p>
                  </div>

                  <p className='feedback_name'>
                    Участник проекта «Интеграция зеленых технологий в устойчивое развитие Арктики»
                  </p>
                  <p className='feedBack_title'>
                    Главный драйвер Школы - её организаторы, менторы, наставники. Люди, которые верят в свое дело, живут
                    им.{' '}
                  </p>
                  <div className='feedBack_descript_container'>
                    <p className='feedBack_descript'>

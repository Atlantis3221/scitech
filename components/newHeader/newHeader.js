            ...
            <div className='section_content'>
              ...
              <nav className='navigation' onMouseOver={() => setKeepOpenSubmenu(false)}>
                ...
                <ul className='navigation_list'>
                  ...
                  <li>
                    <Link href={'/developmentProjects'} activeClassName='navigation_link__active'>
                  ...
                  <li>
                    <Link href={'/news'} activeClassName='navigation_link__active'>
                      <a  className={'navigation_link'}>Новости</a>
                    </Link>
                  </li>

                  <li>
                    <Link href={'/reports'} activeClassName='navigation_link__active'>
